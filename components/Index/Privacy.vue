<template>
  <section class="policy" id="policy">
    ...
    <p>Your privacy is important to us. It is erchelpers.com policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://erchelpers.com">https://erchelpers.com</a>, and other sites we own and operate.</p>
    <p>This policy is effective as of 12 May 2021 and was last updated on 12 May 2021.</p>
    ...
    <!-- <h2>Contact Us</h2> -->
    <!-- <p>To make such a request, please contact us at the following address:</p> -->
    <!-- <p>30 N Gould St Suite 1976, Sheridan, WY 82801, United States, <a href="getercspecialists.com">getercspecialists.com</a></p> -->
    <h2>Other</h2>
    ...
    <button class="btn btn-more" @click.prevent="more" key="more">
      View More
      <svg width="20" height="11" viewBox="0 0 20 11" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 1L10 10L19 1" stroke="#59595A" stroke-linecap="round"/></svg>
    </button>
    <button class="btn btn-less" @click.prevent="more" key="less">
      View Less
      <svg width="20" height="11" viewBox="0 0 20 11" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 10L10 1L19 10" stroke="#59595A" stroke-linecap="round"/></svg>
    </button>
  </section>
</template>
<script>
export default {
  methods: {
    more(){
      ...
      document.getElementById('policy').scrollIntoView({block: "start", behavior: "smooth"});
    }
  },
  mounted(){
    const formHeight = document.querySelector('.leads .form').clientHeight
    this.$el.style.maxHeight = `${formHeight}px`
  }
}
</script>
...
.policy{
  ...
  &:after{
    content: "";
    background: linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #FFFFFF 80.73%);
    width: 100%;
    height: 200px;
    position: absolute;
    left: 0; bottom: 0;
